  ...
  def build(self):
    ...
    # Wind uses the Beaufort scale
        if self.sconfig['metric'] == str(1) and self.sconfig['wind'] == str(1):
          ...
          if wind > 50:
              gust = 'With High winds'
          if wind > 62:
              gust = 'With Gale force winds'
          if wind > 75:
              gust = 'With a strong gale force winds'
          if wind > 89:
              gust = 'With Storm winds'
          if wind > 103:
              gust = 'With Violent storm winds'
          if wind > 118:
              gust = 'With Hurricane force winds'
          if wind == '':
              gust = ''
